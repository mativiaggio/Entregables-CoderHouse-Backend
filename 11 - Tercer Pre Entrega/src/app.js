...
mongoose
  .connect(
    `mongodb+srv://matiasviaggio-admin:${env_config.mongoPassword}@coderhousebackend.vocmiqt.mongodb.net/backend`
  )
  .then(() => {
...
app.use(
  session({
    ...
    store: MongoStore.create({
      mongoUrl: `mongodb+srv://matiasviaggio-admin:${env_config.mongoPassword}@coderhousebackend.vocmiqt.mongodb.net/`,
    }),
  })
);
